...
Path:            teralibs/tsf/core/payload/windows/x86/block_api_x86.py
"""
...
class BlockApiX86:
    ...
    def asm_block_api(self, opts=None):
        ...
        asm = Shuffle.from_graphml_file(
            os.path.join(self.data_dir, "block_api.x86.graphml"), arch="x86", name="api_call"
        )
        ...
        replacement = f"db 0xbf, {iv_bytes}"
